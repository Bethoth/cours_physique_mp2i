...
\usepackage[Smaller,makeroom]{cancel}
...
\include{parties/1-méthodes-divers/1-dimensions-unités/dimensions-unités.tex}

\include{parties/1-méthodes-divers/2-incertitudes-expérimentales/incertitudes-expérimentales.tex}

\include{parties/1-méthodes-divers/3-propagation-signal/propagation-signal.tex}

\include{parties/1-méthodes-divers/4-optique-géométrique/optique-géométrique.tex}

\include{parties/1-méthodes-divers/5-introduction-mécanique-quantique/introduction-mécanique-quantique.tex}

\part{Thermodynamique}

\include{parties/2-thermodynamique/1-bases-thermodynamique-modèle-gaz-parfait/bases-thermodynamique-modèle-gaz-parfait.tex}

\include{parties/2-thermodynamique/2-premier-principe-thermodynamique/premier-principe-thermodynamique.tex}

\include{parties/2-thermodynamique/3-second-principe-thermodynamique/second-principe-thermodynamique.tex}

\include{parties/2-thermodynamique/4-changements-état-corps-pur/changements-état-corps-pur.tex}

\include{parties/2-thermodynamique/5-machines-thermiques/machines-thermiques.tex}

\part{Électricité}

\include{parties/3-électricité/1-introduction-électrocinétique/introduction-électrocinétique.tex}

\include{parties/3-électricité/2-régime-transitoire-circuits-linéaires/régime-transitoire-circuits-linéaires.tex}

\include{parties/3-électricité/3-régime-sinusoïdal-forcé-résonance/régime-sinusoïdal-forcé-résonance.tex}

\part{Mécanique}

\include{parties/4-mécanique/1-cinématique/cinématique.tex}

\include{parties/4-mécanique/2-dynamique-point-référentiel-galiléen/dynamique-point-référentiel-galiléen.tex}

\include{parties/4-mécanique/3-énergie-point-matériel/énergie-point-matériel.tex}

\include{parties/4-mécanique/4-mouvement-particules-chargées-champs-électriques-magnétiques/mouvement-particules-chargées-champs-électriques-magnétiques.tex}

\include{parties/4-mécanique/5-moment-cinétique/moment-cinétique.tex}

\include{parties/4-mécanique/6-mouvement-champ-force-centrale/mouvement-champ-force-centrale.tex}

\include{parties/4-mécanique/7-solide-rotation/solide-rotation.tex}

\part{Électromagnétisme}

\include{parties/5-électromagnétisme/1-champ-magnétique-effets/champ-magnétique-effets.tex}

\include{parties/5-électromagnétisme/2-loi-induction/loi-induction.tex}

\include{parties/5-électromagnétisme/3-induction-Neumann/induction-Neumann.tex}

\include{parties/5-électromagnétisme/4-induction-Lorentz/induction-Lorentz.tex}
\end{document}